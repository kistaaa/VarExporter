...
<h1>
	...
	<p>This simple app is mainly for learning/teaching purposes and 100% Svelte! Just edit the variable-value pairs, and it will diferentiate strings, numbers, booleans, arrays and objects, and generate code based on the options provided.</p>
